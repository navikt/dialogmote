...
const MeldMotebehovInnhold = ({ svarMotebehov, motebehovReducer, motebehovSvarReducer }) => {
  ...
  const content = isKvittering ? (
    <MeldMotebehovKvitteringSide motebehovReducer={motebehovReducer} />
  ) : (
    <MeldMotebehovSkjema motebehovSvarReducer={motebehovSvarReducer} svarMotebehov={svarMotebehov} />
  );
  return (
    <React.Fragment>
