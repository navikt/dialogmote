...
const texts = {
  ...
  forklarende: {
    bekreftet:
      'Du har tidligere mottatt en bekreftelse på et tidspunkt for et dialogmøte med NAV og din arbeidsgiver. Møteforespørselen er avbrutt, og du kan se bort fra denne forespørselen. Er det fortsatt aktuelt med et møte, vil du få en ny forespørsel.',
    avbrutt:
      'Du har tidligere mottatt en møteforespørsel med tidspunkter for et dialogmøte med NAV og din arbeidsgiver. Møteforespørselen er avbrutt, og du kan se bort fra denne forespørselen. Er det fortsatt aktuelt med et møte, vil du få en ny forespørsel.',
  },
};
