...
const texts = {
  ...
  hello: 'Hei',
  paragraphCall: 'Har du spørsmål kan du kontakte oss på 55 55 33 33',
...
const Kvittering = ({ mote }) => {
  const tidsted = `${visDato(mote.bekreftetAlternativ.tid).toLowerCase()} kl. ${visKlokkeslett(
    mote.bekreftetAlternativ.tid
  )} i ${mote.bekreftetAlternativ.sted}`;
  ...
  return (
    <div>
      ...
      <div className="panel">
        <h2>
          {texts.hello} {innloggetBruker.navn}
        </h2>
        <div className="blokk">
