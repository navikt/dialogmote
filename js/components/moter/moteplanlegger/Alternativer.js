...
import { fieldPropTypes, motePt, moteplanleggerAlternativPt, moteplanleggerDeltakertypePt } from '../../../propTypes';
...
const Checkbox = (props) => {
  const { input, id, onClick, children } = props;
...
export const Label = ({ tid }) => <DatoOgTid Tag="div" tid={tid} />;
            ...
            return (
              <li className="js-alternativ motetidspunkt" key={index}>
                ...
                <ul className="alternativsvar">
                  <SvarMedIkon bruker={annenBruker} svar={annensSvar} />
                  <NavKan />
                </ul>
              </li>
            );
