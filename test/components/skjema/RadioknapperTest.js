...
describe('Radioknapper', () => {
  ...
  describe('Radioknapp', () => {
    ...
    it('Skal vise barn når visUndertekst er satt', () => {
      const compo = mount(
        <Radioknapp input={input} value={false} id="radio" visUndertekst>
          <p>Test</p>
        </Radioknapp>
      );
    ...
    it('Skal vise barn når disabled er satt', () => {
      const compo = mount(
        <Radioknapp input={input} value={false} id="radio" disabled>
          <p>Test</p>
        </Radioknapp>
      );
      expect(compo.text().trim()).to.equal('Test');
    ...
    it('Skal vise barn når disabled og visUndertekst er satt', () => {
      const compo = mount(
        <Radioknapp input={input} value={false} id="radio" disabled visUndertekst>
          <p>Test</p>
        </Radioknapp>
      );
      expect(compo.text().trim()).to.equal('Test');
    ...
    it('Skal vise barn når radioknapp er valgt', () => {
      const compo = mount(
        <Radioknapp input={input} value id="radio">
          <p>Test</p>
        </Radioknapp>
      );
      expect(compo.text().trim()).to.equal('Test');
    ...
    it('Skal ikke vise barn når radioknapp ikke er valgt', () => {
      const compo = mount(
        <Radioknapp input={input} value={false} id="radio">
          <p>Test</p>
        </Radioknapp>
      );
